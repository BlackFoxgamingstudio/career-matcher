...
[![CI](https://github.com/BlackFoxgamingstudio/career-matcher/actions/workflows/ci.yml/badge.svg)](https://github.com/BlackFoxgamingstudio/career-matcher/actions/workflows/ci.yml)
...
| **REST Gateway** | ✅ Live on Port `8796` | `POST /api/v1/execute`, `GET /health` |
