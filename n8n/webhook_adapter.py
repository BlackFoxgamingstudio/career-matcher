#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-career-matcher
Listens on port 8796 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8796), WebhookHandler)
    print(f"[Sovereign Career Matcher] Webhook Adapter listening on http://0.0.0.0:8796")
