#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-career-matcher
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="NLP-driven career optimization library. Scrapes and parses technical job postings, extracts skill requirements, matches them against a verified codebase knowledge vault, and renders customized ATS-optimized resumes in PDF and Markdown.")
